  ...
  AstroPNG = (function() {
    ...
    */
    ...
    AstroPNG.prototype.read_quantization_parameters = function(length) {
      var data, i, nan_representation;
      length /= 4;
      nan_representation = [this.view.getUint32()];
      data = (function() {
        var _ref, _results;
        _results = [];
        for (i = 1, _ref = length - 1; 1 <= _ref ? i <= _ref : i >= _ref; 1 <= _ref ? i++ : i--) {
          _results.push(this.view.getFloat32());
        }
        return _results;
      }).call(this);
      return this.quantization_parameters = nan_representation.concat(data);
    };
