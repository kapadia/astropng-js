    ...
    */
    ...
    AstroPNG.prototype.readLine = function() {
      ...
      if (this.quantizationParameters != null) {
        ...
        r = this.randomNumbers.slice(this.currentLine * this.width, this.currentLine * this.width + this.width);
        ...
        data = (function() {
          ...
          for (index = 0, _ref2 = dataInteger.length - 1; 0 <= _ref2 ? index <= _ref2 : index >= _ref2; 0 <= _ref2 ? index++ : index--) {
            _results.push((dataInteger[index] - r[index % this.width] + 0.5) * scale + zero);
          }
          return _results;
        }).call(this);
        r = r.slice(this.width);
        indices = [];
