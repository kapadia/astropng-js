  ...
  AstroPNG = (function() {
    ...
    */
    ...
    AstroPNG.prototype.readLine = function() {
      var a, aParam, b, c, data, dataInteger, element, evt, filterCode, index, indices, r, reconData, scale, zero, _i, _len, _len2, _ref;
      aParam = (function() {
        var _ref, _results;
        _results = [];
      ...
      evt.currentLine = this.currentLine;
      evt.numberOfLines = this.height;
